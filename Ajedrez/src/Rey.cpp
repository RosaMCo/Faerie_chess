...
void Rey:: Dibuja()
{
	if (color == blanco)
	{
		...
		glBindTexture(GL_TEXTURE_2D, ETSIDI::getTexture("imagenes/Fichas/W-King.png").id);
	...
	else if (color == negro)
	{
		...
		glEnable(GL_TEXTURE_2D);
		glBindTexture(GL_TEXTURE_2D, ETSIDI::getTexture("imagenes/Fichas/B-King.png").id);
		glDisable(GL_LIGHTING);
	}
